    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                ...
                <h1 class="display-5 text-uppercase mb-10">Dịch vụ chăm sóc thú cưng</h1>
            </div>
            <div class="row g-5">
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            <h5 class="text-uppercase mb-3">Trông hộ thú cưng</h5>
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            <h5 class="text-uppercase mb-3">Thức ăn cho thú cưng</h5>
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            <h5 class="text-uppercase mb-3">Cắt tỉa lông thú cưng</h5>
    ...
    <div class="container-fluid py-5">
        ...
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" >
                ...
                <h5 class="display-5 text-uppercase mb-10">Sản phẩm bán chạy</h5>
            
            </div>
            <div class="owl-carousel product-carousel">
            
                <c:forEach var="item" items="${products_hotdeal}" varStatus="index">
						<div class="pb-5">
					<div
						class="product-item position-relative bg-light d-flex flex-column text-center">
						
						<img class="img-fluid mb-4" src="<c:url value='/template/customer/img/products/${item.img}'/>" alt="">
            ...
            <div class="row g-0 gx-5 align-items-end">
                <div class="col-lg-6">
                    <div class="section-header text-start mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                        <h1 class="display-5 mb-3">Các sản phẩm khác</h1>
                      
                    </div>
                </div>
                <div class="col-lg-6 text-start text-lg-end wow slideInRight" data-wow-delay="0.1s">
                    <ul class="nav nav-pills d-inline-flex justify-content-end mb-5">
                       <c:forEach var="item" items="${itemtype}" varStatus="i">
                       <li class="nav-item me-2">
                       <c:if test="${i.first}">
                       <a class="btn btn-outline-primary border-2 active" data-bs-toggle="pill" href="#tab-1">${item.name}</a>
                       </c:if>
                          <c:if test="${not i.first}">
                       <a class="btn btn-outline-primary border-2" data-bs-toggle="pill" href="#tab-1">${item.name}</a>
                       </c:if>  
                        </li>
                       </c:forEach>
                    ...
                    <c:forEach var="item" items="${ProductPaginate}" varStatus="i">
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-item">
                                <div class="position-relative bg-light overflow-hidden">
                                    <img class="img-fluid w-100" src="<c:url value='/template/customer/img/products/dog/${item.img}'/>" alt="">
                      ...
                      <div class="pagination">
						<c:forEach var="item" begin="1"
							end="${pageinfo.totalPage}" varStatus="loop">	
