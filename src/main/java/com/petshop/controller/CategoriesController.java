...
public class CategoriesController {
	...
	@RequestMapping(value = "/san-pham/{item_id}/{currentPage}")
	public ModelAndView Product(@PathVariable String item_id, @PathVariable String currentPage) {
		ModelAndView mv = new ModelAndView("customer/product");
		...
		mv.addObject("ProductPaginate",
				itemTypeService.GetDataProductPaginate(item_id, pageinfo.getStart(), totalProductPage));
		return mv;
	}
}
